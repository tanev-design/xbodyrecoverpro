...
const reviews: Review[] = [
  {
    name: 'ÐœÐ¸Ð»ÐµÐ½Ð° Ð”Ð¸Ð¼Ð¸Ñ‚Ñ€Ð¾Ð²Ð°',
    date: { bg: 'Ð¿Ñ€ÐµÐ´Ð¸ Ð¼ÐµÑÐµÑ†', en: 'a month ago' },
    bg: 'Ð¡Ñ‚Ñ€Ð°Ñ…Ð¾Ñ‚Ð½Ð¸ Ñ‚Ñ€ÐµÐ½ÑŒÐ¾Ñ€Ð¸ Ð¸ Ð¼Ð½Ð¾Ð³Ð¾ ÐµÑ„ÐµÐºÑ‚Ð¸Ð²Ð½Ð¸ EMS Ñ‚Ñ€ÐµÐ½Ð¸Ñ€Ð¾Ð²ÐºÐ¸! ÐŸÑ€Ð¾Ñ„ÐµÑÐ¸Ð¾Ð½Ð°Ð»Ð½Ð¾ Ð¾Ñ‚Ð½Ð¾ÑˆÐµÐ½Ð¸Ðµ, Ð¸Ð½Ð´Ð¸Ð²Ð¸Ð´ÑƒÐ°Ð»Ð½Ð¾ Ð²Ð½Ð¸Ð¼Ð°Ð½Ð¸Ðµ Ð¸ Ð¼Ð¾Ñ‚Ð¸Ð²Ð¸Ñ€Ð°Ñ‰Ð° Ð°Ñ‚Ð¼Ð¾ÑÑ„ÐµÑ€Ð°. Ð’ÑÑÐºÐ° Ñ‚Ñ€ÐµÐ½Ð¸Ñ€Ð¾Ð²ÐºÐ° Ðµ Ð´Ð¾Ð±Ñ€Ðµ ÑÑ‚Ñ€ÑƒÐºÑ‚ÑƒÑ€Ð¸Ñ€Ð°Ð½Ð° Ð¸ ÑÑŠÐ¾Ð±Ñ€Ð°Ð·ÐµÐ½Ð° Ñ Ð¸Ð½Ð´Ð¸Ð²Ð¸Ð´ÑƒÐ°Ð»Ð½Ð¸Ñ‚Ðµ Ñ†ÐµÐ»Ð¸, Ð° Ñ€ÐµÐ·ÑƒÐ»Ñ‚Ð°Ñ‚Ð¸Ñ‚Ðµ ÑÐ° Ð²Ð¸Ð´Ð¸Ð¼Ð¸ Ð¾Ñ‰Ðµ ÑÐ»ÐµÐ´ Ð¿ÑŠÑ€Ð²Ð¸Ñ‚Ðµ Ð½ÑÐºÐ¾Ð»ÐºÐ¾ Ð¿Ð¾ÑÐµÑ‰ÐµÐ½Ð¸Ñ.',
  ...
  },
  {
    ...
    date: { bg: 'Ð¿Ñ€ÐµÐ´Ð¸ 3 Ð¼ÐµÑÐµÑ†Ð°', en: '3 months ago' },
    bg: 'Ð¡Ñ‚Ñ€Ð°Ñ…Ð¾Ñ‚Ð½Ð¸ Ð¿Ñ€Ð¾Ñ„ÐµÑÐ¸Ð¾Ð½Ð°Ð»Ð¸ÑÑ‚Ð¸ Ð¿ÐµÑ€Ñ„ÐµÐºÑ‚Ð½Ð° Ð¾Ð±ÑÑ‚Ð°Ð½Ð¾Ð²ÐºÐ°. Ð—Ð° ÐºÑ€Ð°Ñ‚ÐºÐ¾Ñ‚Ð¾ Ð²Ñ€ÐµÐ¼Ðµ ÐºÐ¾ÐµÑ‚Ð¾ Ñ…Ð¾Ð´Ñ ÑÐµ Ñ‡ÑƒÐ²ÑÑ‚Ð²Ð°Ð¼ ÑÑŠÐ²ÑÐµÐ¼ Ð² Ð´Ñ€ÑƒÐ³Ð° Ñ„Ð¾Ñ€Ð¼Ð° .',
    en: "Great professionals, perfect environment. In the short time I've been going, I feel in a completely different shape.",
    rating: 5,
  },
  {
    name: 'Ð›ÑŽÑÐ¸Ð°Ð½Ð° Ð“ÑŠÑ€Ð±ÐµÐ²Ð°',
    date: { bg: 'Ð¿Ñ€ÐµÐ´Ð¸ 3 Ð¼ÐµÑÐµÑ†Ð°', en: '3 months ago' },
    bg: 'ÐÐµÐ²ÐµÑ€Ð¾ÑÑ‚Ð½Ð¾ Ð¼ÑÑÑ‚Ð¾! ÐžÐ±Ð¸Ñ‡Ð°Ð¼ Ð¼ÐµÑÑ‚Ð°, Ð½Ð° ÐºÐ¾Ð¸Ñ‚Ð¾ Ñ€Ð°Ð±Ð¾Ñ‚ÑÑ‚ ÑÐ°Ð¼Ð¾ Ð¿Ñ€Ð¾Ñ„ÐµÑÐ¸Ð¾Ð½Ð°Ð»Ð¸ÑÑ‚Ð¸ Ð² ÑÑ„ÐµÑ€Ð°Ñ‚Ð° ÑÐ¸.',
